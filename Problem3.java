...
Time Complexity : O(Max Depth of the Trie Structure)
Space Complexity : O(Num of words in Dictionary)

The idea is to use Trie data structure to store words in dictionary. Now iterate each words in the sentence and upon finding a word in dictionary we truncate the search and returns the first word in dictionary.
**/
